...
Visit the Customer Service Request Submission Page:
Assuming your URLs are set up as in the example:

http://127.0.0.1:8000/customers/submit/
Visit the Request Tracking Page:

http://127.0.0.1:8000/customers/track/
Check the API Endpoints:
If you created viewsets, you can access the API via:
